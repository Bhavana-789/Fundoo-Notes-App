  ...
  return (
    <DrawerContentScrollView props={props}>
      <View style={styles.body}>
        <Text style={{fontSize: 28, color:'black', fontFamily: 'arial'}}>Fundoo Notes</Text>
      </View>
      <View style={{flex: 1, paddingTop: 10}}>
        <DrawerItem
        icon={({color}) => (
          <MaterialCommunityIcons name="lightbulb-outline" color={color} size={24} />
        )}
        label={() => (
        ...
        <DrawerItem
        icon={({color}) => (
          <Entypo name="plus" color={color} size={24} />
        )}
        label={() => (
